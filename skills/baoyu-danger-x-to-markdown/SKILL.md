...
description: Converts X (Twitter) tweets and articles to markdown with YAML front matter. Uses reverse-engineered API requiring user consent. Use when user mentions "X to markdown", "tweet to markdown", "save tweet", or provides x.com/twitter.com URLs for conversion. 关键词：推特保存、推文转换。
---
...
**Prerequisites**: Requires `bun` runtime. Install if not available: `npm install -g bun`
