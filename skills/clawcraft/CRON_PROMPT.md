...
- Read the JSON response from curl directly. No external tools needed for parsing.
- First, read your persona file to understand your goals, priority rules, and trading strategy.
